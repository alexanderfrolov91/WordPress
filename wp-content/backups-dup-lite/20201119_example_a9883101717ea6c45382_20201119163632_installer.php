...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20201119_example_a9883101717ea6c45382_20201119163632_archive.zip';
	const ARCHIVE_SIZE		 = '62282266';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a988310-19163632';
    const SECONDARY_PACKAGE_HASH = 'cbda32e-19163632';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.40==');
		self::log('----------------------------------------------------');
